...
$archiveName = "Iconify-Search-for-PowerPoint-v$($metadata.version).zip"
$outputDirectory = Join-Path $root "release"
$archivePath = Join-Path $outputDirectory $archiveName
$staging = Join-Path ([System.IO.Path]::GetTempPath()) ("iconify-powerpoint-package-" + [guid]::NewGuid().ToString("N"))
$files = @(
  "Install Iconify Search for PowerPoint.cmd",
  "Uninstall Iconify Search for PowerPoint.cmd",
  "manifest.xml",
  "INSTALLATION.txt",
  "README.md",
  "CHANGELOG.md",
