...
The recommended release file is `Iconify-Search-for-PowerPoint-v1.0.1.zip`. Its accompanying `.sha256` file can be checked on Windows with:

```powershell
(Get-FileHash .\Iconify-Search-for-PowerPoint-v1.0.1.zip -Algorithm SHA256).Hash
```
