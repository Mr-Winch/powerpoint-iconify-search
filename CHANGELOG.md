...
- Promoted the complete PowerPoint add-in to its first stable public version.
...
- Restored the CMD installer without automatically launching PowerPoint.
...
- Moved Clear all beside the insert action.
